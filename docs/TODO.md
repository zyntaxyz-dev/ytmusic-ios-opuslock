...
| TODO-005 | Pendiente | Validar build real en CI (primer run verde) | Artifact `OpusLock.dylib` arm64 | Actions run |
| TODO-006 | Pendiente | Prueba en dispositivo: pill muestra `774/141` en WiFi y celular | Captura + itag pill | `README.md` §5 |
| TODO-007 | Pendiente | Confirmar claves prefs `Always High` con Frida en build 9.35.2 | `frida-trace` hits | `scripts/dump_classes.sh` |
